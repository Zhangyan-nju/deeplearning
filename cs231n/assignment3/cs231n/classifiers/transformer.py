...
class CaptioningTransformer(nn.Module):
    ...
    def forward(self, features, captions):
        ...
        #     dimensions.                                                          #
        caption_embeded = self.embedding(captions)  
        captions_in = self.positional_encoding(caption_embeded) # [N,T,E]
        image_proj = self.visual_projection(features).unsqueeze(1) # [N,E]
        ...
        ############################################################################
        scores = self.transformer(captions_in,image_proj,tgt_mask)
