...
class GaussianDiffusion(nn.Module):
    ...
    def predict_noise_from_start(self, x_t, t, x_start):
        ...
        sqrt_alphas_cumprod = extract(self.sqrt_alphas_cumprod,t,x_t.shape)
        sqrt_one_minus_alphas_cumprod = extract(self.sqrt_one_minus_alphas_cumprod,t,x_t.shape)
        pred_noise = (x_t - x_start * sqrt_alphas_cumprod) / sqrt_one_minus_alphas_cumprod
        ####################################################################
        return pred_noise
    ...
    def q_sample(self, x_start, t, noise):
        ...
        # Hints: 
        # (1) Look at the `__init__` method to see precomputed coefficients.
        # (2) Use the `extract` function defined above to extract the coefficients
        # for the given time step `t`. 
        # (3) Recall that sampling from N(mu, sigma^2)
    ...
    def p_losses(self, x_start, model_kwargs={}):
        ...
        loss = torch.mean(loss_weight*(target-model_output)**2)
