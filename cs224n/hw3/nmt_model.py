...
class NMT(nn.Module):
    ...
    def __init__(self, embed_size, hidden_size, vocab, dropout_rate=0.2):
        ...
        self.encoder = nn.LSTM(input_size=embed_size+hidden_size,hidden_size=hidden_size,bidirectional=True)
        # 注意decoder输入的维度！！！！！！
    ...
    def encode(self, source_padded: torch.Tensor, source_lengths: List[int], grader_params=None) -> Tuple[
        ...
        output,(last_hidden, last_cell) = self.encoder(X)  # (src_len, b, h*2)
    ...
    def decode(self, enc_hiddens: torch.Tensor, enc_masks: torch.Tensor,
        ...
        Y = self.model_embeddings.target(target_padded) # [tge_len, b, vocab_size]
        ...
        for Y_t in torch.split(Y, 1,dim=0):
            ...
            combined_outputs.append(o_t) # list of [b, h]
            o_prev = o_t
